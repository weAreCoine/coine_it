        ...
        <div className="relative">
            ...
            <div className="relative">
                <div
                    ...
                    style={!isPlaying ? { touchAction: 'none' } : undefined}
                ...
                {showInfo && (
                    <div className="absolute inset-0 flex flex-col justify-start gap-4 overflow-y-auto border-2 border-black bg-white/80 p-6 text-sm leading-relaxed backdrop-blur-sm">
                        <p className="text-xl font-semibold">Game Of Life</p>
                        <p>
                            Stai vedendo un automa cellulare ideato dal matematico <strong>John Conway</strong> nel 1970. È un gioco a zero giocatori:
                            la sua evoluzione è determinata dallo stato iniziale, senza ulteriori input.
                        </p>
            ...
            <div className="mt-2 flex justify-between">
                ...
                <div className="flex gap-2">
                    ...
                    {!isPlaying && (
                        <button
                            onClick={() => setBoard(Array.from({ length: CELLS }, () => Array(CELLS).fill(false)))}
                            className="game-of-life__button"
                        >
